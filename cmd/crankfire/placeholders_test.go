...
func TestContextWithVariableStore(t *testing.T) {
	...
	ctxWithStore := contextWithVariableStore(ctx, store)

	retrieved := variableStoreFromContext(ctxWithStore)
	if retrieved == nil {
...
func TestVariableStoreFromContext(t *testing.T) {
	...
	ctx := context.TODO()
	got := variableStoreFromContext(ctx)
	if got != nil {
...
func TestApplyPlaceholders_WithVariables(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := applyPlaceholdersWithVariables(tt.template, tt.record, tt.store)
			if got != tt.want {
...
func TestApplyPlaceholders_EmptyDefault(t *testing.T) {
	...
	got := applyPlaceholdersWithVariables(template, record, store)
...
func TestApplyPlaceholdersToMapWithVariables(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := applyPlaceholdersToMapWithVariables(tt.values, tt.record, tt.store)
			if !reflect.DeepEqual(got, tt.want) {
